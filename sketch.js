...
function setParameters(data){
  ...
  let x_min = parseFloat(paras[2])
  let x_max = parseFloat(paras[3])
  let y_min = parseFloat(paras[4])
  let y_max = parseFloat(paras[5])
  coordrange = [[x_min, x_max], [y_min, y_max]]
  let gxmin = parseFloat(paras[6])
  let gxmax = parseFloat(paras[7])
  let gymin = parseFloat(paras[8])
  let gymax = parseFloat(paras[9])
  v0 = [gxmin, gymin]
  vMax = [gxmax, gymax]
  stepsX = parseFloat(paras[10])
  stepsY = parseFloat(paras[11])
  let a = parseFloat(paras[12])
  let b = parseFloat(paras[13])
  let c = parseFloat(paras[14])
  let d = parseFloat(paras[15])
  A = [[a,b], [c, d]]
  console.log(A)
}
